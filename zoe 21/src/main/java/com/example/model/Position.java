...
public class Position {
    ...
    private int calculateScore_heuristic(Stack<Integer> s, boolean isMaximizingPlayersTurn) {
        // looks quite the same to MachinePlayer.makeMove() - this is only called for the scoring-values if no win/loss
        // can be determined in the next few moves. makeMove gets called *first* for performance-reasons
